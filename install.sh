...
echo ""
echo "  Restart OpenCode, then:"
echo "    • type /setup            -> analysis + recommendations"
echo "    • or just ask            : \"recommend automations for this project\""
echo "      (the skill triggers itself)"
echo ""
